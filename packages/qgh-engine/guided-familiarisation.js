(function initializeQghGuidedFamiliarisation(root) {
  ...
  function tourSteps(kind) {
    ...
    const voice = {
      ...
      text: 'Open VOICE to prepare offline recognition. Hold PTT for one complete controller call, then release; Continuous Listening is optional. Pilot sound starts muted. For replies, wear headphones, select HEADPHONES · PILOT READBACKS, complete the audio test and confirm. Never use pilot replies on speakers. Open VOICE to mute before disconnecting headphones. Pilot voices target 100 words per minute; your new call interrupts the old reply without delaying the aircraft.',
